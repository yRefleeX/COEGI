<html>
  ...
  <div class="conteiner">
       ...
       <div class="coluna1">
        ...
        <img src="https://moodle.cmp.ifsp.edu.br/pluginfile.php/1/theme_moove/logo/1706647608/LogoIFSPCMP_moodle.png" style="height: 80px; width: 180px;">
        ...
        <hr>
                ...
                <div id="listMot">
					...
					<?php
					 ...
					 while (  $row = mysqli_fetch_assoc($query)) {
						  ...
						  echo'<form id="formulario"><input type="hidden" name="idMot" value="'.$row['motorista_id'].'"><button onclick = " enviarFormulario() " type="button" id="salvar" name="salvar" style=" cursor: pointer; color:blue; float:left">saiba mais</button></form></div></div>';
         ...
         <!-- Tela de login -->
          ...
          <div id="FormularioLogin">
            ...
            <img id="img" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjSAK1iGtaQ6QTCdpq1iGyJki53MmDISyYag&s">
        ...
        <div class="formularioCentro">
         ...
         <div id="EditarMotorista">
           ...
           <p>Preencha os campos em que deseja alterar a informação. Para manter as informações que deseja, deixe o campo especifico em branco.</p>
         ...
         <div id="InfMotorista">
			...
			<?php
								 ...
								 include_once("listaMotoristaId.php");
								 echo ($id);
           ...
           <p><b>Motorista: Clewton Luis Ferreira</b></p>
           ...
           <div id="descMotorista">  
             ...
             <p>Rotas: Campinas</p>
             <p>Preço: 110.00</p>
             <p>telefone:(19)912634772</p>
             <p>Periodo: Matutino, Vespertino e Noturno</p>
             <p>Classificação: 4.7 Estrelas</p>
